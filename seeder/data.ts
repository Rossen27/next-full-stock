export const rooms = [
  {
    name: "迷人的工作室，距離威爾斯海灘不到 10 英里！",
    pricePerNight: 1600,
    description:
      "友好的氛圍和自然美景等待著您來訪威爾斯鎮！入住這個設備齊全的 1 浴室工作室，享受方便前往幾個海灘的便利，包括威爾斯海灘和德雷克斯島海灘，還有距離只有 8 英里的瑞秋·卡森國家野生動物保護區 - 這是觀看野生動物的最佳地點。不僅如此，市中心距離度假租賃地點僅 10 分鐘。",
  ...
  {
    name: "風景如畫的兩層農舍，帶私人熱水浴缸",
    pricePerNight: 2400,
    description:
      "在這個風景如畫的威爾斯住宅中，為家人或大團體提供充足的空間，是放鬆度假的完美之地，擁有迷人的典型緬因風格！在附近美麗的海灘上度過一天，回家後可享受寬敞的後院和果園，孩子們可以在那裡玩耍，還有一個露台和燃氣烤架，適合夏日的燒烤。",
  ...
  {
    "name": "朴茨茅斯市中心私人度假屋！帶熱水浴缸",
    "pricePerNight": 85,
    "description": "朴茨茅斯最好的地理位置！這棟布置精美、寬敞且私密的住宅非常適合參觀這座充滿活力的城市中所有必看的景點和歷史地標。坐落在皮斯卡塔卡河岸邊，距離Strawbery Banke博物館、Prescott公園、USS Albacore博物館和市場廣場等景點僅數分鐘路程！",
  ...
  },
  {
    "name": "波士頓安靜街區寬敞套房",
    "pricePerNight": 95,
    "description": "我們最大的房間，配有一張大床和折疊沙發。舒適容納2-3名成人，最多可容納4名成人。以愛爾蘭主題的色彩和藝術裝飾，設有帶淋浴的私人浴室，配備智能電視、小冰箱、桌子和椅子。可以在靠窗的休息區享受城市景觀。位於三樓，沒有電梯。",
  ...
  },
  {
    ...
    "pricePerNight": 36,
    "description": "我們最大的房間，配有一張大床和折疊沙發。舒適容納2-3名成人，最多可容納4名成人。以愛爾蘭主題的色彩和藝術裝飾，設有帶淋浴的私人浴室，配備智能電視、小冰箱、桌子和椅子。可以在靠窗的休息區享受城市景觀。位於三樓，沒有電梯。",
    "address": "1029 Godfrey Street, 波特蘭, OR, 97205",
    "guestCapacity": 2,
    "numOfBeds": 2,
    "isInternet": true,
    "isBreakfast": true,
  ...
  {
    "name": "Ischgl Garni酒店，4星級房間舒適度",
    "pricePerNight": 82,
    "description": "我們最大的房間，配有一張大床和折疊沙發。舒適容納2-3名成人，最多可容納4名成人。以愛爾蘭主題的色彩和藝術裝飾，設有帶淋浴的私人浴室，配備智能電視、小冰箱、桌子和椅子。可以在靠窗的休息區享受城市景觀。位於三樓，沒有電梯。",
    "address": "2645 Parrish Avenue, 聖路易斯, MO, 63116",
    "guestCapacity": 5,
    "numOfBeds": 3,
    "isInternet": true,
    "isBreakfast": true,
